...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/npm/echarts@6/dist/echarts.min.js" crossorigin="anonymous"></script>
</head>
<body>
  <div id="chart"></div>
  <div class="footer">Generated by Visuologia &middot; ${new Date().toLocaleDateString()}</div>
  <script>
