...
const DEPT_BUDGET_ROWS: Record<string, unknown>[] = [
  { department: 'Engineering', team: 'Platform', budget: 480000 },
  { department: 'Engineering', team: 'Mobile', budget: 310000 },
  { department: 'Sales', team: 'Enterprise', budget: 260000 },
  { department: 'Sales', team: 'SMB', budget: 150000 },
  { department: 'Marketing', team: 'Growth', budget: 190000 },
  { department: 'Marketing', team: 'Brand', budget: 110000 },
  { department: 'Support', team: 'Tier 1', budget: 95000 },
  { department: 'Support', team: 'Tier 2', budget: 70000 },
];
...
export const STARTER_TEMPLATES: StarterTemplate[] = [
  ...
  },
  {
    ...
    category: 'Finance',
    description: 'Treemap of annual budget across departments and teams',
    icon: 'Wallet',
    prompt: 'Visualize how our annual budget is allocated across departments and their teams.',
    sampleFilename: 'department-budget.csv',
    sampleData: DEPT_BUDGET_ROWS,
    chartSelection: resolveVariant('treemap', undefined),
  },
  {
    id: 'sprint-velocity',
