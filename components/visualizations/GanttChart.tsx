...
export default function GanttChart({ data }: GanttChartProps) {
  ...
  const { startDate, endDate, totalDays, columnWidth, columns } =
    useMemo(() => {
                  ...
                  return task.dependencies.map((depId) => {
                    ...
                    if (endX > startX + 10) {
                      ...
                      path = `M ${startX} ${sourceY}
                            ...
                            C ${startX + loopOut + 20} ${sourceY}, ${
                        startX + loopOut + 20
                      } ${midY}, ${startX + loopOut} ${midY}
                            L ${endX - loopOut} ${midY}
                            C ${endX - loopOut - 20} ${midY}, ${
                        endX - loopOut - 20
                      } ${targetY}, ${endX} ${targetY}`;
                      isDashed = true;
                    }
                        ...
                        <>
                          <polygon
                            points={`${x + width / 2},${y} ${x + width},${
                              ...
                              y + LAYOUT_CONSTANTS.barHeight
                            } ${x},${y + LAYOUT_CONSTANTS.barHeight / 2}`}
                            fill={color}
